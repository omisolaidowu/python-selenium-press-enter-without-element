...
class registerWebActions(todoLocator):
    ...
    def inputfirstName(self, firstName):
        first_name_field = self.driver.find_element(By.XPATH, self.First_Name)
    ...
    def inputlastName(self, lastName):
        last_name_field = self.driver.find_element(By.XPATH, self.Last_Name)
        return self.driver.execute_script(
    ...
    def inputPhone(self, phone):
        phone_field = self.driver.find_element(By.XPATH, self.Phone)
        return self.driver.execute_script(
    ...
    def inputpasswordConfirm(self, password_confirm):
        password_confirm_field = self.driver.find_element(By.XPATH, self.Password_Confirm)
        return self.driver.execute_script(
